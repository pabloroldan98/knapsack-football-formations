...
if main_option == "Lista de jugadores":
    ...
    display_to_key = {
        key.replace("_", " ").strip().title(): key
        for key in jornadas_dict.keys()
    }
    ...
    selected_jornada = (
        [] if selected_display_jornada == "Siguiente partido"
        else jornadas_dict[display_to_key[selected_display_jornada]]
    )
