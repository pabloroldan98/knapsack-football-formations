...
from rotowire import get_rotowire_data, get_players_start_probabilities_dict_rotowire
...
def safe_get_start_probabilities(label, file_name):
    try:
        ...
        data = get_players_start_probabilities_dict_rotowire(
            file_name=file_name,
            force_scrape=True
        )
...
print("##############################")
##############################
print("Scraping rotowire...")
print("##############################")

# try:


    # laliga_prices, laliga_positions, laliga_forms, laliga_start_probabilities, laliga_price_trends = get_rotowire_data(
    #     price_file_name="rotowire_laliga_players_prices",
    #     positions_file_name="rotowire_laliga_players_positions",
    #     forms_file_name="rotowire_laliga_players_forms",
    #     start_probability_file_name="rotowire_laliga_players_start_probabilities",
    #     price_trends_file_name="rotowire_laliga_players_price_trends",
    #     force_scrape=True
    # )
    # print("Prices:")
    ...
    #     print(team, players)
    # laliga_start_probabilities = get_players_start_probabilities_dict_rotowire(
    #     file_name="rotowire_laliga_players_start_probabilities",
    #     force_scrape=True
    # )
    # print("\nStart Probabilities:")
    # for team, players in laliga_start_probabilities.items():
...
laliga_start_probabilities = safe_get_start_probabilities(
    "LaLiga", "rotowire_laliga_players_start_probabilities"
)
premier_start_probabilities = safe_get_start_probabilities(
    "Premier League", "rotowire_premier_players_start_probabilities"
)
seriea_start_probabilities = safe_get_start_probabilities(
    "Serie A", "rotowire_seriea_players_start_probabilities"
)
bundesliga_start_probabilities = safe_get_start_probabilities(
    "Bundesliga", "rotowire_bundesliga_players_start_probabilities"
)
ligueone_start_probabilities = safe_get_start_probabilities(
    "Ligue 1", "rotowire_ligueone_players_start_probabilities"
)
# segunda_start_probabilities = safe_get_start_probabilities(
#     "Segunda División", "rotowire_segunda_players_start_probabilities"
# )

champions_start_probabilities = safe_get_start_probabilities(
    "Champions League", "rotowire_champions_players_start_probabilities"
)
# europaleague_start_probabilities = safe_get_start_probabilities(
#     "Europa League", "rotowire_europaleague_players_start_probabilities"
# )
# conference_start_probabilities = safe_get_start_probabilities(
#     "Conference League", "rotowire_conference_players_start_probabilities"
# )
...
#     "Copa América", "rotowire_copaamerica_players_start_probabilities"
# )
