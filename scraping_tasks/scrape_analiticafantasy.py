...
def safe_get_start_probabilities(label, file_name):
    try:
        ...
        data = get_players_start_probabilities_dict_analiticafantasy(
            file_name=file_name,
            force_scrape=True
        )
...
# try:
    ...
    # laliga_prices, laliga_positions, laliga_forms, laliga_start_probabilities, laliga_price_trends = get_analiticafantasy_data(
    ...
    #     print(team, players)
    # laliga_start_probabilities = get_players_start_probabilities_dict_analiticafantasy(
...
#     "Segunda División", "analiticafantasy_segunda_players_start_probabilities"
# )
#
