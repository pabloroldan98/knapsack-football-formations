...
from sportsgambler import get_sportsgambler_data, get_players_start_probabilities_dict_sportsgambler
...
def safe_get_start_probabilities(label, file_name):
    try:
        ...
        data = get_players_start_probabilities_dict_sportsgambler(
            file_name=file_name,
            force_scrape=True
        )
...
print("##############################")
##############################
print("Scraping sportsgambler...")
print("##############################")

# try:


    # laliga_prices, laliga_positions, laliga_forms, laliga_start_probabilities, laliga_price_trends = get_sportsgambler_data(
    #     price_file_name="sportsgambler_laliga_players_prices",
    #     positions_file_name="sportsgambler_laliga_players_positions",
    #     forms_file_name="sportsgambler_laliga_players_forms",
    #     start_probability_file_name="sportsgambler_laliga_players_start_probabilities",
    #     price_trends_file_name="sportsgambler_laliga_players_price_trends",
    #     force_scrape=True
    # )
    # print("Prices:")
    ...
    #     print(team, players)
    # laliga_start_probabilities = get_players_start_probabilities_dict_sportsgambler(
    #     file_name="sportsgambler_laliga_players_start_probabilities",
    #     force_scrape=True
    # )
    # print("\nStart Probabilities:")
    # for team, players in laliga_start_probabilities.items():
...
laliga_start_probabilities = safe_get_start_probabilities(
    "LaLiga", "sportsgambler_laliga_players_start_probabilities"
)
premier_start_probabilities = safe_get_start_probabilities(
    "Premier League", "sportsgambler_premier_players_start_probabilities"
)
seriea_start_probabilities = safe_get_start_probabilities(
    "Serie A", "sportsgambler_seriea_players_start_probabilities"
)
bundesliga_start_probabilities = safe_get_start_probabilities(
    "Bundesliga", "sportsgambler_bundesliga_players_start_probabilities"
)
ligueone_start_probabilities = safe_get_start_probabilities(
    "Ligue 1", "sportsgambler_ligueone_players_start_probabilities"
)
segunda_start_probabilities = safe_get_start_probabilities(
    "Segunda División", "sportsgambler_segunda_players_start_probabilities"
)

champions_start_probabilities = safe_get_start_probabilities(
    "Champions League", "sportsgambler_champions_players_start_probabilities"
)
europaleague_start_probabilities = safe_get_start_probabilities(
    "Europa League", "sportsgambler_europaleague_players_start_probabilities"
)
conference_start_probabilities = safe_get_start_probabilities(
    "Conference League", "sportsgambler_conference_players_start_probabilities"
)
mundialito_start_probabilities = safe_get_start_probabilities(
    "Mundialito", "sportsgambler_mundialito_players_start_probabilities"
)

mundial_start_probabilities = safe_get_start_probabilities(
    "Mundial", "sportsgambler_mundial_players_start_probabilities"
)
eurocopa_start_probabilities = safe_get_start_probabilities(
    "Eurocopa", "sportsgambler_eurocopa_players_start_probabilities"
)
copaamerica_start_probabilities = safe_get_start_probabilities(
    "Copa América", "sportsgambler_copaamerica_players_start_probabilities"
)
