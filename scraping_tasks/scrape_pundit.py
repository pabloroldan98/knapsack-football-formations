...
from pundit import get_pundit_data, get_players_start_probabilities_dict_pundit
...
def safe_get_start_probabilities(label, file_name):
    try:
        ...
        data = get_players_start_probabilities_dict_pundit(
            file_name=file_name,
            force_scrape=True
        )
...
print("##############################")
##############################
print("Scraping PUNDIT...")
print("##############################")


premier_start_probabilities = safe_get_start_probabilities(
    "Premier League", "pundit_premier_players_start_probabilities"
)
